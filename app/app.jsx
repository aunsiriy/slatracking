...
function Hero({role}){
  ...
  return React.createElement('section',{className:'hero',style:{background:'url("/assets/Container10.png") center / cover no-repeat'}},
...
function SiteFooter(){
  return React.createElement('footer',{className:'site-footer'},
    React.createElement('div',{className:'brand-mark footer-brand'},
      React.createElement(Image,{className:'brand-logo footer-logo',src:'/assets/sla-logo-checkmark.png',alt:'SLA',width:36,height:36}),
  ...
  return React.createElement('header',{className:'topbar'},
    React.createElement('div',{className:'topbar-left'},
      React.createElement('div',{className:'brand-mark'},
        React.createElement(Image,{className:'brand-logo',src:'/sla-logo.svg',alt:'SLA',width:36,height:36}),
...
function ModuleCard({title,desc,descStyle,badge,cta,ctaVariant,stat,enabled,accent,href,cardStyle,titleStyle,img}){
  return React.createElement('div',{className:'card module-card-v2'+(accent?' is-accent':'')+(enabled?'':' is-view-only'),style:cardStyle},
    ...
    React.createElement('div',{className:'module-card-art'},
      React.createElement(Image,{src:img,alt:title,fill:true,sizes:'104px',className:'module-card-art-img'})
    ),
