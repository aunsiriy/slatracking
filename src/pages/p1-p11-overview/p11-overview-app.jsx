...
function TopBar(){
  return React.createElement('header',{className:'ptop'},
    React.createElement('div',{className:'ptop-left'},
      React.createElement('img',{className:'ptop-logo',src:'assets/sla-logo-checkmark.png',alt:'SLA'}),
    ...
    React.createElement('a',{className:'ptop-back',href:'index.html'},React.createElement(Icon,{name:'corner-up-left',size:16}),'กลับไปหน้าหลัก')
  );
}
...
function App(){
  ...
  function goToQir(node){window.location.href='qir-annual-form.html';}
  return React.createElement(React.Fragment,null,
