...
function TopBar(){
  return React.createElement('header',{className:'otop'},
    React.createElement('div',{className:'otop-left'},
      React.createElement('img',{className:'otop-logo',src:'assets/sla-logo-checkmark.png',alt:'SLA'}),
    ...
    React.createElement('a',{className:'otop-back',href:'index.html'},React.createElement(Icon,{name:'corner-up-left',size:16}),'กลับไปหน้าหลัก')
  );
}
...
function FeatureCards(){
  const cards=[
    {icon:'trending-up',title:'SLA Tracking',desc:'ติดตามสถานะ SLA ระดับหน้างานแบบ Workflow',cta:'ไปที่ SLA Tracking',href:'sla-status-tracking.html'},
    {icon:'file-text',title:'รายงานผล SLA ระดับฝ่าย/เขต/สนง.ใหญ่',desc:'กรอกและส่งผลการดำเนินงาน SLA ประจำรอบ',cta:'ไปที่แบบฟอร์มรายงาน',href:'sla-report-form.html'},
