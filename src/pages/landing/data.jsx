...
const ROLES = {
  admin:{
    ...
    cards:{
      ...
      learning:{enabled:true,badge:'ภาพรวมองค์กร',cta:'ดู Learning Form',ctaVariant:'secondary',stat:'8 หน่วยงานอยู่ระหว่างวิเคราะห์',href:'learning-form.html'}
    }
  },
  manager:{
    ...
    cards:{
      ...
      sla:{enabled:true,badge:'ต้องดำเนินการ',cta:'ไปที่รายงาน SLA',ctaVariant:'primary',stat:'4 ต้องกรอก · 2 ถูกคืน',href:'sla-overview.html'},
      learning:{enabled:true,badge:'ได้รับมอบหมาย',cta:'ไปที่ Learning Form',ctaVariant:'secondary',stat:'2 รายการรอดำเนินการ',href:'learning-form.html'}
    }
  },
  staff:{
    ...
    cards:{
      ...
      learning:{enabled:true,badge:'ได้รับมอบหมาย',cta:'กรอก Learning Form',ctaVariant:'primary',stat:'1 รายการ ครบกำหนด 20 ก.ค.',href:'p1-p11-overview.html'}
    }
  }
};
