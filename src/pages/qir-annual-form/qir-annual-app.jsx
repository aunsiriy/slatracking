...
function TopBar(){
  return React.createElement('header',{className:'qtop'},
    React.createElement('div',{className:'qtop-left'},
      React.createElement('img',{className:'qtop-logo',src:'assets/sla-logo-checkmark.png',alt:'SLA'}),
    ...
    React.createElement('a',{className:'qtop-back',href:'index.html'},React.createElement(Icon,{name:'corner-up-left',size:16}),'กลับไปหน้าหลัก')
  );
}

function Breadcrumb(){
  return React.createElement('div',{className:'qbreadcrumb'},
    React.createElement('a',{href:'index.html'},'ข้อเสนอโอกาสการปรับปรุงฯ (QIR)'),
    React.createElement(Icon,{name:'chevron-right',size:13}),
    React.createElement('a',{href:'p1-p11-overview.html'},'P1-P11 / QIR ประจำปี'),
    React.createElement(Icon,{name:'chevron-right',size:13}),
    ...
    React.createElement('main',{className:'qcontent'},
      ...
      React.createElement('div',{className:'card qform-card'},
        ...
        React.createElement('div',{className:'qform-footer'},
          React.createElement(Button,{variant:'secondary',size:'md',onClick:()=>{window.location.href='p1-p11-overview.html';}},'ย้อนกลับ'),
