    ...
    React.createElement('main',{className:'rcontent'},
      ...
      React.createElement('div',{className:'rpage-head'},
        React.createElement('div',{className:'rpage-head-top'},
          ...
          React.createElement('a',{className:'rlevel-switch',href:'sla-report-form-level2.html'},'สลับไปหน้ารายงานระดับกอง',React.createElement(Icon,{name:'arrow-right',size:14}))
        ),
