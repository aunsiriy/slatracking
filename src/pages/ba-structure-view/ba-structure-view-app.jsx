...
function BaStructureView(){
  ...
  return React.createElement(React.Fragment,null,
    React.createElement('header',{className:'bv-header'},
      React.createElement('a',{href:'index.html',className:'bv-back'},React.createElement(Icon,{name:'corner-up-left',size:15}),'กลับหน้าหลัก'),
...
ReactDOM.createRoot(document.getElementById('root')).render(React.createElement(BaStructureView));
