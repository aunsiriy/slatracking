...
function TopBar(){
  return React.createElement('header',{className:'ltop'},
    React.createElement('div',{className:'ltop-left'},
      React.createElement('img',{className:'ltop-logo',src:'assets/sla-logo-checkmark.png',alt:'SLA'}),
    ...
    React.createElement('a',{className:'ltop-back',href:'index.html'},React.createElement(Icon,{name:'corner-up-left',size:16}),'กลับไปหน้าหลัก')
  );
}
